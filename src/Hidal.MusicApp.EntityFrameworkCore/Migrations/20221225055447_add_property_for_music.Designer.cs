...
namespace Hidal.MusicApp.Migrations
{
    ...
    [Migration("20221225055447_add_property_for_music")]
    partial class add_property_for_music
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hidal.MusicApp.DbMigrator.AppUsers.AppUser", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Hidal.MusicApp.DbMigrator.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hidal.MusicApp.DbMigrator.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hidal.MusicApp.DbMigrator.Comments.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("PerformanceMusicId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PerformanceMusicId");

                    b.ToTable("AppComments", (string)null);
                });

            modelBuilder.Entity("Hidal.MusicApp.DbMigrator.Favourites.Favourite", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppFavourites", (string)null);
                });

            modelBuilder.Entity("Hidal.MusicApp.DbMigrator.PerformanceMusics.PerformanceMusic", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppPerformanceMusics", (string)null);
                });

            modelBuilder.Entity("Hidal.MusicApp.DbMigrator.Singers.Singer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppSingers", (string)null);
                });
            ...
            modelBuilder.Entity("Hidal.MusicApp.DbMigrator.Songs.Song", b =>
                {
                    ...
                    b.ToTable("AppSongs", (string)null);
                });
            ...
            modelBuilder.Entity("Hidal.MusicApp.DbMigrator.Comments.Comment", b =>
                {
                    b.HasOne("Hidal.MusicApp.DbMigrator.AppUsers.AppUser", "AppUser")
                        .WithMany("Comments")
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hidal.MusicApp.DbMigrator.PerformanceMusics.PerformanceMusic", "PerformanceMusic")
                        .WithMany("Comments")
                        .HasForeignKey("PerformanceMusicId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AppUser");

                    b.Navigation("PerformanceMusic");
                });
            ...
            modelBuilder.Entity("Hidal.MusicApp.DbMigrator.PerformanceMusics.PerformanceMusic", b =>
                {
                    b.HasOne("Hidal.MusicApp.DbMigrator.Singers.Singer", "Singer")
            ...
            modelBuilder.Entity("Hidal.MusicApp.DbMigrator.Singers.Singer", b =>
                {
                    b.Navigation("PerformanceMusics");
                });
